...
export default function TopBar({ tableName, documentName, deleteProtection = true, onDeleteProtectionChange, onRenameTable, onRenameDocument, onOpenChatAgent, chatAgentOpen }: Props) {
    ...
    <div className="topbar">
      ...
      <div className="topbar-right">
        ...
        <div className="topbar-icon-group">
          ...
          <button
            className={`topbar-icon-btn${chatAgentOpen ? " topbar-icon-btn-active" : ""}`}
            title={t("topbar.ai")}
            onClick={() => onOpenChatAgent?.()}
          >
            {/* Four-pointed star (Table Agent entry) */}
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <defs>
                <linearGradient id="topbar_agent_grad" x1="3" y1="3" x2="17" y2="17" gradientUnits="userSpaceOnUse">
              ...
              <path
                d="M10 1.5c.3 0 .55.22.6.52l1.1 4.03c.26.96 1.01 1.71 1.97 1.97l4.03 1.1c.5.14.5.88 0 1.02l-4.03 1.1c-.96.26-1.71 1.01-1.97 1.97l-1.1 4.03c-.14.5-.88.5-1.02 0l-1.1-4.03c-.26-.96-1.01-1.71-1.97-1.97l-4.03-1.1c-.5-.14-.5-.88 0-1.02l4.03-1.1c.96-.26 1.71-1.01 1.97-1.97l1.1-4.03c.05-.3.3-.52.6-.52z"
                fill="url(#topbar_agent_grad)"
              />
            </svg>
          </button>
        </div>
