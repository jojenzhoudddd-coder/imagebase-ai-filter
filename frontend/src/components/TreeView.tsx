...
function MoveIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      <path d="M10 3L13 6H21.5C21.7652 6 22.0196 6.10536 22.2071 6.29289C22.3946 6.48043 22.5 6.73478 22.5 7V20C22.5 20.2652 22.3946 20.5196 22.2071 20.7071C22.0196 20.8946 21.7652 21 21.5 21H2.5C2.23478 21 1.98043 20.8946 1.79289 20.7071C1.60536 20.5196 1.5 20.2652 1.5 20V16.224H3.49867L3.5 19H20.5V8H12.04L9 5H3.5L3.49867 10.224H1.5V4C1.5 3.73478 1.60536 3.48043 1.79289 3.29289C1.98043 3.10536 2.23478 3 2.5 3H10ZM10.1667 9.94267C10.2544 9.94269 10.3412 9.96001 10.4222 9.99364C10.5032 10.0273 10.5768 10.0766 10.6387 10.1387L13.0267 12.528C13.0888 12.5899 13.138 12.6635 13.1716 12.7445C13.2052 12.8255 13.2225 12.9123 13.2225 13C13.2225 13.0877 13.2052 13.1745 13.1716 13.2555C13.138 13.3365 13.0888 13.4101 13.0267 13.472L10.64 15.8613C10.5468 15.9547 10.4281 16.0184 10.2987 16.0443C10.1694 16.0701 10.0352 16.057 9.91333 16.0066C9.79142 15.9562 9.6872 15.8708 9.61386 15.7612C9.54052 15.6515 9.50136 15.5226 9.50133 15.3907V14H1.50133V12H9.50133V10.6093C9.50133 10.5218 9.51858 10.4351 9.55208 10.3542C9.58558 10.2733 9.63469 10.1998 9.6966 10.1379C9.7585 10.076 9.83199 10.0269 9.91288 9.99341C9.99376 9.95991 10.0805 9.94267 10.168 9.94267H10.1667Z" fill="currentColor"/>
    </svg>
  );
}
