...
const ICONS: Record<string, (p: IconProps) => JSX.Element> = {
  ...
  AutoNumber: ({ size = 16, className }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}><path d="M3.10039 7.49993V3.82446L2.51993 4.23482C2.11406 4.52176 1.55243 4.42535 1.26549 4.01948C0.978554 3.61361 1.07497 3.05197 1.48084 2.76504L3.00766 1.68562C3.80247 1.12371 4.90039 1.6921 4.90039 2.66548V7.49993C4.90039 7.99699 4.49744 8.39993 4.00039 8.39993C3.50333 8.39993 3.10039 7.99699 3.10039 7.49993Z" fill="currentColor"/><path d="M4.00022 11.0859C3.44793 11.0859 3.00022 11.5337 3.00022 12.0859V16.9999H1.37087C0.984975 16.9999 0.744539 17.4185 0.938981 17.7518L3.56846 22.2595C3.7614 22.5903 4.2393 22.5903 4.43224 22.2595L7.06172 17.7518C7.25617 17.4185 7.01573 16.9999 6.62983 16.9999H5.00022V12.0859C5.00022 11.5337 4.5525 11.0859 4.00022 11.0859Z" fill="currentColor"/><path d="M10.0002 19.0859C9.44793 19.0859 9.00022 19.5337 9.00022 20.0859C9.00022 20.6382 9.44793 21.0859 10.0002 21.0859H22.0002C22.5525 21.0859 23.0002 20.6382 23.0002 20.0859C23.0002 19.5337 22.5525 19.0859 22.0002 19.0859H10.0002Z" fill="currentColor"/><path d="M9.00022 12.0859C9.00022 11.5337 9.44793 11.0859 10.0002 11.0859H22.0002C22.5525 11.0859 23.0002 11.5337 23.0002 12.0859C23.0002 12.6382 22.5525 13.0859 22.0002 13.0859H10.0002C9.44793 13.0859 9.00022 12.6382 9.00022 12.0859Z" fill="currentColor"/><path d="M10.0002 3C9.44793 3 9.00022 3.44772 9.00022 4C9.00022 4.55228 9.44793 5 10.0002 5H22.0002C22.5525 5 23.0002 4.55228 23.0002 4C23.0002 3.44772 22.5525 3 22.0002 3H10.0002Z" fill="currentColor"/></svg>
  ),
