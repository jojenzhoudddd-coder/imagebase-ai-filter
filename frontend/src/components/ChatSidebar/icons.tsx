...
export function AcknowledgeIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      <path d="M1.5 6.98991C1.5 6.24154 1.8487 5.53589 2.44317 5.08128C5.02565 3.10635 8.57115 2.96911 11.2986 4.73849L11.5516 4.90263C11.7208 5.01243 11.8769 5.13753 12.0186 5.27546C12.1362 5.16748 12.2631 5.0682 12.3988 4.97894L12.5954 4.84966C15.3709 3.02384 19.0064 3.19278 21.6006 5.26815C22.1691 5.72294 22.5 6.41148 22.5 7.13949V19.0757C22.5 20.1703 21.2488 20.7936 20.3751 20.1343L20.0387 19.8804C17.8869 18.2568 14.9359 18.2465 12.7784 19.8226C12.6164 20.0528 12.3511 20.1951 12.0724 20.2069C11.7236 20.2483 11.3723 20.0803 11.1856 19.7827C9.07359 18.2429 6.18685 18.2437 4.06933 19.8223L3.63666 20.1448C2.75455 20.8024 1.5 20.1729 1.5 19.0726V6.98991ZM11.0488 7.45609C11.0488 7.06522 10.8509 6.70093 10.523 6.48821L10.2699 6.32407C8.21295 4.98961 5.53896 5.09312 3.59128 6.58259C3.46442 6.67961 3.39 6.8302 3.39 6.98991V17.9949C5.71022 16.5024 8.61477 16.3492 11.0488 17.51V7.45609ZM20.61 7.13949C20.61 6.98563 20.5401 6.84011 20.4199 6.744C18.4651 5.18011 15.7255 5.0528 13.6341 6.42865L13.4375 6.55793C13.1263 6.7627 12.9388 7.11032 12.9388 7.48292V17.5356C15.377 16.3744 18.2783 16.5169 20.61 17.9808V7.13949Z" fill="currentColor"/>
    </svg>
  );
}
