...
export const zh: TranslationKeys = {
  ...
  "auth.login.handlePlaceholder": "quan 或 you@example.com",
  "auth.login.passwordLabel": "密码",
  "auth.login.passwordPlaceholder": "请输入密码",
  "auth.login.remember": "30 天内免登录",
  ...
  "auth.register.usernameLabel": "用户名（可选）",
  "auth.register.usernamePlaceholder": "2-32 字符 a-z A-Z 0-9 _ -",
  "auth.register.usernameHint": "登录时可输入用户名或邮箱。",
  "auth.register.nameLabel": "显示名",
  "auth.register.namePlaceholder": "你希望别人怎么称呼你",
