export const en = {
  ...
  "chat.empty.preset.answer.prompt": "Answer my questions using the tables in this document",
  "chat.empty.preset.save.label": "Save new messages to my base automatically",
  "chat.empty.preset.save.prompt": "Automatically save new messages into the matching table in this document",
